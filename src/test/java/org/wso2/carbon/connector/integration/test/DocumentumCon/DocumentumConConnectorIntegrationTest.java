...
* under the License.
*/
package org.wso2.carbon.connector.integration.test.DocumentumCon;
 ...
 */
public class DocumentumConConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    @Test(enabled = true, groups = {"wso2.ei"}, description = "DocumentumCon test case")
